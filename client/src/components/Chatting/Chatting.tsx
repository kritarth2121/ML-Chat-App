    ...
    useEffect(() => {
        fetch("https://randomuser.me/api/?gender=female")
            ...
            .then(function (data) {
                console.log(data);
                if (Dates.current) {
                    Dates.current.innerHTML = formatDate(new Date());
                }
                ...
                if (myDiv.current) {
                    myDiv.current.style.backgroundImage = `url(${JSON.stringify(
...
`;
    ...
    function botResponse(rawText: string) {
        ...
        axios
            .get("https://kritarthmlforchat.azurewebsites.net/get", {
                headers: {
        ...
        <div className="msger -mt-10  mx-4 xxx">
                            ...
                            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        You can talk limited with a free
                                        account,buy our premium to talk
                                        unlimited
                                    </p>
                                </div>
            ...
            <div className="msger-header ">
                <div className="msger-header-title font-bold">
                    <i className="fas fa-female"></i> Chatting Application,Dont
                    use slangs ,Use proper English ,don't use other languages
            ...
            <main className="msger-chat" ref={msgerChat}>
                <div className="msg left-msg">
                    <div className="msg-img" id="myDiv" ref={myDiv}></div>
            ...
            {typing ? (
                <div className="ml-5 m-2"> {BOT_NAME} is Typing</div>
            ) : (
                <div></div>
            )}
